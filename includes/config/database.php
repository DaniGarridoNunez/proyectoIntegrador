...
function getConexion() {
    ...
    if (mysqli_num_rows($comprobarDB) > 0) {
        ...
        ";
                ...
                -- USUARIOS
                -- PROFESIONALES
                INSERT INTO usuarios(nombre, apellido, correo, password, especialidad, descripcion, fecha_nac, foto, rol) VALUES ('Luis', 'Jerez', 'luisjerez@gmail.com', '" . password_hash('1234', PASSWORD_DEFAULT) . "', 'nutricionista', 'Cinco años de experiencia licenciado en la Universidad Europea de Madrid', '2000-10-23', 'pruebasProfesional2.jpg', 'profesional');
                INSERT INTO usuarios(nombre, apellido, correo, password, especialidad, descripcion, fecha_nac, foto, rol) VALUES ('Eric', 'Hernandez', 'erichernandez@gmail.com', '" . password_hash('1234', PASSWORD_DEFAULT) . "', 'nutricionista', 'cinco años de experiencia licenciado en la Universidad Europea de Madrid', '1980-03-15', 'pruebasProfesional2.jpg', 'profesional');
                INSERT INTO usuarios(nombre, apellido, correo, password, especialidad, descripcion, fecha_nac, foto, rol) VALUES ('Angel', 'Perez', 'angelperez@gmail.com', '" . password_hash('1234', PASSWORD_DEFAULT) . "', 'psicologo', 'cinco años de experiencia licenciado en la Universidad Europea de Madrid', '1992-07-30', 'pruebasProfesional2.jpg', 'profesional');
                INSERT INTO usuarios(nombre, apellido, correo, password, especialidad, descripcion, fecha_nac, foto, rol) VALUES ('Mario', 'Rodriguez', 'mariorodriguez@gmail.com', '" . password_hash('1234', PASSWORD_DEFAULT) . "', 'psicologo', 'cinco años de experiencia licenciado en la Universidad Europea de Madrid', '1975-01-09', 'pruebasProfesional2.jpg', 'profesional');
                INSERT INTO usuarios(nombre, apellido, correo, password, especialidad, descripcion, fecha_nac, foto, rol) VALUES ('Enrique', 'Fernandez', 'enriquefernandez@gmail.com', '" . password_hash('1234', PASSWORD_DEFAULT) . "', 'nutricionista', 'cinco años de experiencia licenciado en la Universidad Europea de Madrid', '1997-08-11', 'pruebasProfesional2.jpg', 'profesional');
                    
                    -- PACIENTES
                INSERT INTO usuarios(nombre, apellido, correo, password, especialidad, descripcion, fecha_nac, foto, rol) VALUES ('Fernando', 'Alonso', 'fernandoalonso@gmail.com', '" . password_hash('1234', PASSWORD_DEFAULT) . "', NULL, NULL, '2003-02-11', 'pruebas.jpg', 'paciente');
                INSERT INTO usuarios(nombre, apellido, correo, password, especialidad, descripcion, fecha_nac, foto, rol) VALUES ('Enrique', 'Fernandez', 'enriquefernandez@gmail.com', '" . password_hash('1234', PASSWORD_DEFAULT) . "', NULL, NULL, '2001-01-23', 'pruebas.jpg', 'paciente');
                INSERT INTO usuarios(nombre, apellido, correo, password, especialidad, descripcion, fecha_nac, foto, rol) VALUES ('Enrique', 'Fernandez', 'enriquefernandez@gmail.com', '" . password_hash('1234', PASSWORD_DEFAULT) . "', NULL, NULL, '2004-08-12', 'pruebas.jpg', 'paciente');
                INSERT INTO usuarios(nombre, apellido, correo, password, especialidad, descripcion, fecha_nac, foto, rol) VALUES ('Enrique', 'Fernandez', 'enriquefernandez@gmail.com', '" . password_hash('1234', PASSWORD_DEFAULT) . "', NULL, NULL, '1990-09-08', 'pruebas.jpg', 'paciente');
                INSERT INTO usuarios(nombre, apellido, correo, password, especialidad, descripcion, fecha_nac, foto, rol) VALUES ('Enrique', 'Fernandez', 'enriquefernandez@gmail.com', '" . password_hash('1234', PASSWORD_DEFAULT) . "', NULL, NULL, '1999-12-30', 'pruebas.jpg', 'paciente');
                    
                    -- ADMINISTRADORES
                INSERT INTO usuarios(nombre, apellido, correo, password, especialidad, descripcion, fecha_nac, rol) VALUES (NULL, NULL, 'dani@admin.com', '" . password_hash('1234', PASSWORD_DEFAULT) . "', NULL, NULL, NULL, 'admin');
                INSERT INTO usuarios(nombre, apellido, correo, password, especialidad, descripcion, fecha_nac, rol) VALUES (NULL, NULL, 'hugo@admin.com', '" . password_hash('1234', PASSWORD_DEFAULT) . "', NULL, NULL, NULL, 'admin');
                INSERT INTO usuarios(nombre, apellido, correo, password, especialidad, descripcion, fecha_nac, rol) VALUES (NULL, NULL, 'josep@admin.com', '" . password_hash('1234', PASSWORD_DEFAULT) . "', NULL, NULL, NULL, 'admin');
                INSERT INTO usuarios(nombre, apellido, correo, password, especialidad, descripcion, fecha_nac, rol) VALUES (NULL, NULL, 'sara@admin.com', '" . password_hash('1234', PASSWORD_DEFAULT) . "', NULL, NULL, NULL, 'admin');
                INSERT INTO usuarios(nombre, apellido, correo, password, especialidad, descripcion, fecha_nac, rol) VALUES (NULL, NULL, 'irene@admin.com', '" . password_hash('1234', PASSWORD_DEFAULT) . "', NULL, NULL, NULL, 'admin');
