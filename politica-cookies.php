...
<head>
    ...
    <title>Cookies Policy for Psycologix</title>
...
<?php include 'includes/templates/header.php' ?>
    ...
    <div class="contenedor">
        ...
        <section>
            ...
            <ul>
                <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Cookies Policy) refers to Psycologix LLC, C/ Olivos Nº15 Madrid, 28001.</li>
        ...
        <section>
            <h2 style="text-align: left;">The use of the Cookies</h2>
            <h3 style="text-align: left;">Type of Cookies We Use</h3>
            <p>Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close your web browser.</p>
            <p>We use both session and persistent Cookies for the purposes set out below:</p>
        </section>
    
        <section>
            <h3 style="text-align: left;">Necessary / Essential Cookies</h3>
        ...
        <section>
            <h3 style="text-align: left;">Functionality Cookies</h3>
        ...
        <section>
            <h2 style="text-align: left;">Your Choices Regarding Cookies</h2>
        ...
        <section>
            <h2 style="text-align: left;">More Information about Cookies</h2>
            <p>You can learn more about cookies: <a href="#">What Are Cookies?</a></p>
        </section>
